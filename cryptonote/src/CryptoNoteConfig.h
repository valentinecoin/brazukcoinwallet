...
const int      P2P_DEFAULT_PORT                              =  45889;
const int      RPC_DEFAULT_PORT                              =  45888;
...
const std::initializer_list<CheckpointData> CHECKPOINTS = { 
  { 19, "9a509b41b0ce98d4c4c0b74050291720316ff59bd8bcec1df43ed829a5cb4b7b" },
};
